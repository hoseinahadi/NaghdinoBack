...
namespace AppleShopWebApi.Controllers
{
    ...
    {
        private readonly IUserMessageBusiness _business;

        public UserMessageController(IUserMessageBusiness business)
        {
            _business = business;
        }

        [HttpPost("AddNewUserMessage")]
        [Authorize]
        public IActionResult AddNew(UserMessage model)
        {
        ...
        public IActionResult Update(UserMessage model)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpPost("SearchUserMessage")]
        public IActionResult Search(UserMessage model, int recordCount)
        {
