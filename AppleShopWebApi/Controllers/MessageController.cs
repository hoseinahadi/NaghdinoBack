...
namespace AppleShopWebApi.Controllers
{
    ...
    {
        private readonly IMessageBusiness _business;

        public MessageController(IMessageBusiness Business)
        {
            _business = Business;
        }
        [HttpPost("AddNewMessage")]
        public IActionResult AddNew(MessageAddEditModel model)
        {
        ...
        public IActionResult Update(MessageAddEditModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        public IActionResult Delete(int id)
        {
            ...
            if (id!=0)
            {
                ...
                return BadRequest("This Message Not Found");
            }
