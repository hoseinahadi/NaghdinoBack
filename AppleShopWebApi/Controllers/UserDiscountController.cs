...
namespace AppleShopWebApi.Controllers
{
    ...
    {
        private readonly IUserDiscountBusiness _business;

        public UserDiscountController(IUserDiscountBusiness business)
        {
            _business = business;
        }

        [HttpPost("AddNewUserDiscount")]
        [Authorize]
        public IActionResult AddNew(UserDiscount model)
        {
        ...
        [HttpPost("UpdateUserDiscount")]
        [Authorize]

        public IActionResult Update(UserDiscount model)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpPost("SearchUserDiscount")]
        public IActionResult Search(UserDiscount model, int recordCount)
        {
