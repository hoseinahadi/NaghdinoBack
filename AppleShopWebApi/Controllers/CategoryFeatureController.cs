...
namespace AppleShopWebApi.Controllers
{
    ...
    {
        private readonly ICategoryFeatureBusiness _business;

        public CategoryFeatureController(ICategoryFeatureBusiness business)
        {
            _business = business;
        }
        ...
        [HttpPost("AddNewCategoryFeature")]
        [Authorize]
        public IActionResult AddNew(CategoryFeature model)
        {
        ...
        [HttpPost("SearchCategoryFeature")]
        public IActionResult Search(CategoryFeature model, int recordCount)
        {
        ...
        [HttpPost("UpdateCategoryFeature")]
        [Authorize]
        public IActionResult Update(CategoryFeature model)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpDelete("DeleteCategoryFeature")]
