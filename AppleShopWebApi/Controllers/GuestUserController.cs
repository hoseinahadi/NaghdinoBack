...
namespace AppleShopWebApi.Controllers
{
    ...
    {
        private readonly IGuestUserBusiness _business;

        public GuestUserController(IGuestUserBusiness Business)
        {
            _business = Business;
        }
        [HttpPost("AddNewGuestUser")]
        public IActionResult AddNew(GuestUserAddEditModel model)
        {
        ...
        [HttpPost("UpdateGuestUser")]
        public IActionResult Update(GuestUserAddEditModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpPost("SearchGuestUser")]
        public IActionResult Search(GuestUserSearchModel model ,int recordCount)
        {
        ...
        public IActionResult Delete(int id)
        {
            ...
            if (id!=0)
            {
                ...
                return BadRequest("This GuestUser Not Found");
            }

            return BadRequest("Select Id ");
        }

        [HttpGet("GetGuestUser")]
