    ...
    public class UserRepository:IUserRepository
    {
        ...
        public OperationResult Add(User model)
        {
            ...
            try
            {
                ...
                {
                    return op.Failed("This User Name Has Exist", model.UserId);
                }
                db.Users.Add(model);
                db.SaveChanges();
                return op.Succeed("Add New User succeed", model.UserId);
            }
            catch (Exception ex)
            {
                return op.Failed("Add New user failed in repository =" + ex.Message, model.UserId);
            }
        }
